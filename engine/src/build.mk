...
OUTPUT_OBJDIR = $(GAME_ROOT)/src/objs/$(GAME_CONFIG)/$(BIN)
endif # BIN
...
OUTPUT_OBJDIR = $(GAME_ROOT)/src/objs/$(GAME_CONFIG)/$(LIB)
endif # LIB
...
INCLUDES += $(filter-out, $(CURDIR), $(shell find $(CURDIR) -type d))
...
CXXFLAGS += -DGAME_CONFIG=\"${GAME_CONFIG}\"
